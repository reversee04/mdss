...
async function main() {
  ...
  // 2. Clean up any other diseases not in our focused list (skip if encounters exist)
  // Note: This is skipped to avoid foreign key constraint violations
  // Only the 4 focus diseases are configured for use
